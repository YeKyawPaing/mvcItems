...
namespace MvcItem.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemID,ItemName,ItemCategory,ItemPrice,ItemCount")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemID,ItemName,ItemCategory,ItemPrice,ItemCount")] Item item)
        {
            if (ModelState.IsValid)
            {
